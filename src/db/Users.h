...
class Users
{
  public:
    ...
    /**  For column priv  */
    ///Get the value of the column priv, returns the default value if the column is null
    const int8_t &getValueOfPriv() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int8_t> &getPriv() const noexcept;

    ///Set the value of the column priv
    void setPriv(const int8_t &pPriv) noexcept;
    void setPrivToNull() noexcept;
