...
class Chapters
{
  public:
    struct Cols
    {
        ...
        static const std::string _bookid;
    };
     ...
     */
    explicit Chapters(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Chapters(const Json::Value &pJson) noexcept(false);
     ...
     */
    Chapters(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    /**  For column bookid  */
    ///Get the value of the column bookid, returns the default value if the column is null
    const int32_t &getValueOfBookid() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int32_t> &getBookid() const noexcept;

    ///Set the value of the column bookid
  ...
  private:
    friend Mapper<Chapters>;
#ifdef __cpp_impl_coroutine
    friend CoroMapper<Chapters>;
#endif
